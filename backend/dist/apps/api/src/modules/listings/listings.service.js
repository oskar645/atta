...
let ListingsService = class ListingsService {
    ...
    async findAll(params) {
        ...
        listings.sort(this.compareFeedListings);
        return {
    ...
    async remove(id, authUser) {
        ...
        if (!canDelete) {
            throw new common_1.ForbiddenException('Only owner or admin can delete listing');
        }
    ...
    compareFeedListings(a, b) {
        const aPublished = a.publishedAt?.getTime();
        const bPublished = b.publishedAt?.getTime();
